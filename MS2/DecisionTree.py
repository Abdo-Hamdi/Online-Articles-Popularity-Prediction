...
model5 = tree.DecisionTreeClassifier(max_depth=10, min_samples_split=10, min_samples_leaf=5).fit(X_train, y_train)
model6 = tree.DecisionTreeClassifier(max_depth=10, min_samples_split=2, min_samples_leaf=1).fit(X_train, y_train)
model7 = tree.DecisionTreeClassifier(max_depth=3, min_samples_split=10, min_samples_leaf=5).fit(X_train, y_train)
model8 = tree.DecisionTreeClassifier(max_depth=5, min_samples_split=2, min_samples_leaf=1).fit(X_train, y_train)
...
accuracy_model7 = accuracy_score(y_test, y_pred_model7)
accuracy_model8 = accuracy_score(y_test, y_pred_model8)

print("Test Accuracy (model 5 of decision tree ):", accuracy_model5)
print("Test Accuracy (model 6 of decision tree ):", accuracy_model6)
print("Test Accuracy (model 7 of decision tree ):", accuracy_model7)
print("Test Accuracy (model 8 of decision tree ):", accuracy_model8)
